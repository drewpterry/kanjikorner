...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Words.duplicate_word'
        db.add_column(u'manageset_words', 'duplicate_word',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Words.published'
        db.add_column(u'manageset_words', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Words.duplicate_word'
        db.delete_column(u'manageset_words', 'duplicate_word')

        # Deleting field 'Words.published'
        db.delete_column(u'manageset_words', 'published')
