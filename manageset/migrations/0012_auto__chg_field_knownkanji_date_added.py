...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'KnownKanji.date_added'
        db.alter_column(u'manageset_knownkanji', 'date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'KnownKanji.date_added'
        db.alter_column(u'manageset_knownkanji', 'date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
