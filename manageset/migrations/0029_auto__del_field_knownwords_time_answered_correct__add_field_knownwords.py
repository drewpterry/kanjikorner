...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'KnownWords.times_answered_correct'
        db.add_column(u'manageset_knownwords', 'times_answered_correct',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'KnownWords.times_answered_correct'
        db.delete_column(u'manageset_knownwords', 'times_answered_correct')
