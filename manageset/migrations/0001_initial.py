...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Kanji'
        db.create_table(u'manageset_kanji', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('kanji_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('kanji_meaning', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('readings', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('strokes', self.gf('django.db.models.fields.IntegerField')()),
            ('grade', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'manageset', ['Kanji'])

        # Adding model 'Words'
        db.create_table(u'manageset_words', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('real_word', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('meaning', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('hiragana', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('frequency', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'manageset', ['Words'])

        # Adding M2M table for field kanji on 'Words'
        m2m_table_name = db.shorten_name(u'manageset_words_kanji')
        ...
        db.create_unique(m2m_table_name, ['words_id', 'kanji_id'])

        # Adding model 'Sets'
        db.create_table(u'manageset_sets', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'manageset', ['Sets'])

        # Adding M2M table for field words on 'Sets'
        m2m_table_name = db.shorten_name(u'manageset_sets_words')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('sets', models.ForeignKey(orm[u'manageset.sets'], null=False)),
            ('words', models.ForeignKey(orm[u'manageset.words'], null=False))
        ))
        db.create_unique(m2m_table_name, ['sets_id', 'words_id'])

        # Adding M2M table for field kanji on 'Sets'
        m2m_table_name = db.shorten_name(u'manageset_sets_kanji')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('sets', models.ForeignKey(orm[u'manageset.sets'], null=False)),
            ('kanji', models.ForeignKey(orm[u'manageset.kanji'], null=False))
        ))
        db.create_unique(m2m_table_name, ['sets_id', 'kanji_id'])

        # Adding model 'UserProfile'
        db.create_table(u'manageset_userprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal(u'manageset', ['UserProfile'])

        # Adding M2M table for field user_sets on 'UserProfile'
        m2m_table_name = db.shorten_name(u'manageset_userprofile_user_sets')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'manageset_kanji')

        # Deleting model 'Words'
        db.delete_table(u'manageset_words')

        # Removing M2M table for field kanji on 'Words'
        db.delete_table(db.shorten_name(u'manageset_words_kanji'))

        # Deleting model 'Sets'
        db.delete_table(u'manageset_sets')

        # Removing M2M table for field words on 'Sets'
        db.delete_table(db.shorten_name(u'manageset_sets_words'))

        # Removing M2M table for field kanji on 'Sets'
        db.delete_table(db.shorten_name(u'manageset_sets_kanji'))

        # Deleting model 'UserProfile'
        db.delete_table(u'manageset_userprofile')
