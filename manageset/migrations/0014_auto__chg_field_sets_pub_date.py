...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sets.pub_date'
        db.alter_column(u'manageset_sets', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Sets.pub_date'
        db.alter_column(u'manageset_sets', 'pub_date', self.gf('django.db.models.fields.DateTimeField')())
