...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Words.jlpt_level'
        db.add_column(u'manageset_words', 'jlpt_level',
                      self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Words.jlpt_level'
        db.delete_column(u'manageset_words', 'jlpt_level')
    ...
    models = {
        ...
        u'manageset.words': {
            ...
            'combined_frequency': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'duplicate_word': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'frequency': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'frequency_thousand': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'frequency_two': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'hiragana': ('django.db.models.fields.CharField', [], {'max_length': '301'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jlpt_level': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'kanji': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['manageset.Kanji']", 'symmetrical': 'False', 'blank': 'True'}),
            'meaning': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
