...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Kanji.on_kun_readings'
        db.add_column(u'manageset_kanji', 'on_kun_readings',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Kanji.on_kun_readings'
        db.delete_column(u'manageset_kanji', 'on_kun_readings')
