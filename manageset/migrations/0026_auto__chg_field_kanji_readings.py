...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Kanji.readings'
        db.alter_column(u'manageset_kanji', 'readings', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Kanji.readings'
        db.alter_column(u'manageset_kanji', 'readings', self.gf('django.db.models.fields.CharField')(default='not available', max_length=200))
