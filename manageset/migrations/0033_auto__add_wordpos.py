...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WordPos'
        db.create_table(u'manageset_wordpos', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('word', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['manageset.Words'])),
            ('pos', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ))
        db.send_create_signal(u'manageset', ['WordPos'])


    def backwards(self, orm):
        # Deleting model 'WordPos'
        db.delete_table(u'manageset_wordpos')
