...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Words.frequency_two'
        db.add_column(u'manageset_words', 'frequency_two',
                      self.gf('django.db.models.fields.IntegerField')(null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Words.frequency_two'
        db.delete_column(u'manageset_words', 'frequency_two')
