...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'KnownKanji.number_of_chosen_words'
        db.add_column(u'manageset_knownkanji', 'number_of_chosen_words',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'KnownKanji.number_of_chosen_words'
        db.delete_column(u'manageset_knownkanji', 'number_of_chosen_words')
