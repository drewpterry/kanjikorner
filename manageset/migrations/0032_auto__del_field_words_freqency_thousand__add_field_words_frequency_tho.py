...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Words.freqency_thousand'
        db.delete_column(u'manageset_words', 'freqency_thousand')

        # Adding field 'Words.frequency_thousand'
        db.add_column(u'manageset_words', 'frequency_thousand',
                      self.gf('django.db.models.fields.IntegerField')(null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Words.freqency_thousand'
        db.add_column(u'manageset_words', 'freqency_thousand',
                      self.gf('django.db.models.fields.IntegerField')(null=True, db_index=True),
                      keep_default=False)

        # Deleting field 'Words.frequency_thousand'
        db.delete_column(u'manageset_words', 'frequency_thousand')
