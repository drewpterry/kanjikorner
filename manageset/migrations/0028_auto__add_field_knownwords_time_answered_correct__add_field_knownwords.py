...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'KnownWords.time_answered_correct'
        db.add_column(u'manageset_knownwords', 'time_answered_correct',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'KnownWords.times_answered_wrong'
        db.add_column(u'manageset_knownwords', 'times_answered_wrong',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'KnownWords.correct_percentage'
        db.add_column(u'manageset_knownwords', 'correct_percentage',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'KnownWords.time_answered_correct'
        db.delete_column(u'manageset_knownwords', 'time_answered_correct')

        # Deleting field 'KnownWords.times_answered_wrong'
        db.delete_column(u'manageset_knownwords', 'times_answered_wrong')

        # Deleting field 'KnownWords.correct_percentage'
        db.delete_column(u'manageset_knownwords', 'correct_percentage')
    ...
    models = {
        ...
        u'manageset.knownwords': {
            ...
            'time_answered_correct': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
