...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Words.frequency'
        db.alter_column(u'manageset_words', 'frequency', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Words.frequency'
        db.alter_column(u'manageset_words', 'frequency', self.gf('django.db.models.fields.IntegerField')(default=0))
