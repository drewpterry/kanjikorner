...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'manageset_kanji', 'strokes', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Kanji.grade'
        db.alter_column(u'manageset_kanji', 'grade', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Kanji.strokes'
        db.alter_column(u'manageset_kanji', 'strokes', self.gf('django.db.models.fields.IntegerField')(default=100))

        # Changing field 'Kanji.grade'
        db.alter_column(u'manageset_kanji', 'grade', self.gf('django.db.models.fields.IntegerField')(default=100))
