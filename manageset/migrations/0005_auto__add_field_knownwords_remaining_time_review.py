...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'KnownWords.remaining_time_review'
        db.add_column(u'manageset_knownwords', 'remaining_time_review',
                      self.gf('django.db.models.fields.TimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'KnownWords.remaining_time_review'
        db.delete_column(u'manageset_knownwords', 'remaining_time_review')
    ...
    models = {
        ...
        u'manageset.knownwords': {
            ...
            'remaining_time_review': ('django.db.models.fields.TimeField', [], {'null': 'True'}),
