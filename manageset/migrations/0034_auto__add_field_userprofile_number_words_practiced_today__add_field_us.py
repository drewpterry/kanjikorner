...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.number_words_practiced_today'
        db.add_column(u'manageset_userprofile', 'number_words_practiced_today',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'UserProfile.words_practied_today_time_marker'
        db.add_column(u'manageset_userprofile', 'words_practied_today_time_marker',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 7, 30, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.most_words_practiced_in_day'
        db.add_column(u'manageset_userprofile', 'most_words_practiced_in_day',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.number_words_practiced_today'
        db.delete_column(u'manageset_userprofile', 'number_words_practiced_today')

        # Deleting field 'UserProfile.words_practied_today_time_marker'
        db.delete_column(u'manageset_userprofile', 'words_practied_today_time_marker')

        # Deleting field 'UserProfile.most_words_practiced_in_day'
        db.delete_column(u'manageset_userprofile', 'most_words_practiced_in_day')
    ...
    models = {
        ...
        u'manageset.userprofile': {
            ...
            'words_practied_today_time_marker': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
