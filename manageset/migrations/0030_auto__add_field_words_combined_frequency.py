...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Words.combined_frequency'
        db.add_column(u'manageset_words', 'combined_frequency',
                      self.gf('django.db.models.fields.IntegerField')(null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Words.combined_frequency'
        db.delete_column(u'manageset_words', 'combined_frequency')
