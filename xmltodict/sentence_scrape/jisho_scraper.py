...
# execfile('xmltodict/sentence_scrape/jisho_scraper.py')
...
def scrape(word_object):
    ...
    sentence = "yay"
    try:
        list_of_sentences = soup.find_all(class_="sentences_set")
        ...
        jlpt_level = "n/a"      
    return [target_url, word_object.real_word, sentence]
